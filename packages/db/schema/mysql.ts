...
export const cmdbRelationships = mysqlTable(
  "cmdb_relationship",
  {
    id: varchar({ length: 64 }).notNull().primaryKey(),
...
export const cmdbOwners = mysqlTable(
  "cmdb_owner",
  {
    id: varchar({ length: 64 }).notNull().primaryKey(),
...
export const mediaTraces = mysqlTable(
  "media_trace",
  {
    id: varchar({ length: 64 }).notNull().primaryKey(),
...
export const mediaTraceEvents = mysqlTable(
  "media_trace_event",
  {
    id: varchar({ length: 64 }).notNull().primaryKey(),
